...
import { submitLoginToken, submitRegisterToken } from "../lib/front";
...
export default function Register() {
    ...
    async function handleRegister(e) {
        ...
        try {
            let passkeyResult = await lid.registerWithPasskey(email);

            await submitRegisterToken(passkeyResult.jwtAccess);
